...
> **Personal note:** I'm using this fork mainly to experiment with fine-tuning Kronos on crypto data (BTC/ETH hourly candles). The upstream repo focuses on daily K-lines but the architecture handles hourly data just fine — just need to adjust the sequence length accordingly.
